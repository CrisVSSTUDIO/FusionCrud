...
@section('crud-content')
    <div class="card">
        ...
        <div class="card-body">
            @can('create-user')
                <a href="{{ route('users.create') }}" class="btn btn-success btn-sm my-2"><i class="bi bi-plus-circle"></i>
                    Adicionar novo utilizador</a>
            @endcan
                            ...
                            <td>
                                <form action="{{ route('users.destroy', $user->id) }}" method="post">
                                    ...
                                    <a href="{{ route('users.show', $user->id) }}" class="btn btn-warning btn-sm"><i
                                            class="bi bi-eye"></i> Mostrar utilizador</a>
