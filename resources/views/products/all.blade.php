...
<div class="pricing-header p-3 pb-md-4 mx-auto text-center container-fluid">
    <div class="card mx-4 mx-md-5 text-center justify-content-center shadow p-3 mb-5 bg-body-tertiary rounded bg-light" style="align-items:center;   background: hsla(0, 0%, 100%, 0.7); backdrop-filter: blur(60px);  ">
        <div class="card-body px-4 py-5 px-md-5">
            <h1 class="display-5 fw-bold ls-tight mb-4 "> <span class="text-muted">Todos os</span>
        ...
        <div class="col">
            <nav aria-label="breadcrumb" class="rounded-3 p-3 mb-4 shadow-lg bg-white border-0">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item " aria-current="page">Todos os assets</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="main-container">
    ...
    <div class="card-body-mine shadow p-3 mb-5 bg-body rounded slide-in">
        ...
        <div class="card-body-info">
            ...
            <span class="card-description mt-2">
                {{ Str::words($product->description ?? 'Sem descrição', 12, '...') }}
            </span>

            <div class="button-area">
                <a class="btn btn-primary  rounded-pill px-3  mt-2" href="{{ route('products.show', $product->id) }}" role="button">Visualizar
                    {{ $product->name ?? 'Asset' }}</a>
            </div>
        </div>
    </div>
