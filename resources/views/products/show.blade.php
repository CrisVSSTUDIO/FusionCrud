...
@section('crud-content')
    ...
    <div class="main-container">
        @if ($filextension)
            @if ($filextension == 'csv')
                <!-- Modal  treino-->
                <div class="modal fade" id="modalTrain{{ $product->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form method="POST" action="{{ route('statistics.post', $product->id) }}"
            ...
            @endif
            <!--Modal detalhes-->
            <div class="modal fade" id="modal_detalhes{{ $product->id }}" tabindex="-1"
                            ...
                            @switch($filextension)
                                @case($filextension == 'glb')
                                    <model-viewer alt="{{ $product->name ?? 'Sem nome' }}"
                                        ...
                                        loading="lazy" class="card-img-top h-100">
                                    </model-viewer>
                                @break
                                ...
                                @default
                                    <img src="{{ asset('storage/' . $product->upload) }}" alt="{{ $product->name ?? 'Sem nome' }}"
 ...
 --}}
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <x-card title="{{ $product->name ?? 'Sem nome' }}">
                    @if ($filextension)
                        @switch($filextension)
                            @case($filextension == 'glb')
                                <model-viewer alt="{{ $product->name ?? 'Sem nome' }}"
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4 mb-4 ">
        ...
        <div class="card mx-2 slide-right " style="width: 16rem;">
            ...
            @endif
            <div class="card-body">
                <h5 class="">{{ $product->name ?? 'Sem nome' }}</h5>
        ...
        @empty
        <span class="text-warning">Sem outros assets.</span>
        @endforelse
