...
<header class="navbar sticky-top  flex-md-nowrap p-0 shadow" data-bs-theme="dark" style="background-color:#0369a1; ">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="/">{{ config('app.name', 'Laravel') }}</a>
