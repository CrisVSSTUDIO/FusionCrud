                                        ...
                                        <div class="collapse" id="trashed">
                                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                                <li><a href="{{ route('trashed') }}"
                                                    class="link-body-emphasis d-inline-flex text-decoration-none rounded">Trashed items</a></li>
                                        ...
                                        <div class="collapse" id="roles">
                                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                                <li><a href="{{ route('roles.index') }}"
                                                    class="link-body-emphasis d-inline-flex text-decoration-none rounded">See all roles</a></li>
